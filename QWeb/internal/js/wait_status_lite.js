...
return (function (quietMs) {
	...
	var performance_now = (window.__xhrMon && typeof window.__xhrMon.performance_now === "function") ? window.__xhrMon.performance_now : (window.performance && typeof window.performance.now === "function") ? window.performance.now.bind(window.performance) : window.Date.now.bind(window.Date);
