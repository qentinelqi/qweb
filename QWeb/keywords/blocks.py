...
def run_block(block: str, *args, timeout: Union[int, str]=0, **kwargs) -> None:  # pylint: disable=unused-argument
...
def _execute_block(steps: list[dict[str, Any]], timeout: Union[int, str]=0, **kwargs):  # pylint: disable=unused-argument
