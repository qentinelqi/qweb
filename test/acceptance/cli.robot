...
Get version
    ...
    ${result}=          Run Process             ${python_ver}    -m     QWeb   -V              shell=True
    Should Contain      ${result.stdout}        QWeb
    ${result}=          Run Process             ${python_ver}    -m     QWeb   --version       shell=True
    Should Contain      ${result.stdout}        QWeb
...
Print help
    ...
    ${result}=          Run Process             ${python_ver}    -m     QWeb   -h              shell=True
    Should Contain      ${result.stdout}        lists keywords based on input string
    ${result}=          Run Process             ${python_ver}    -m     QWeb   --help          shell=True
    Should Contain      ${result.stdout}        lists keywords based on input string
...
List All
    ...
    ${result}=          Run Process             ${python_ver}    -m     QWeb   -A              shell=True
    Should Contain      ${result.stdout}        Verify Table
    ${result}=          Run Process             ${python_ver}    -m     QWeb   --all           shell=True
    Should Contain      ${result.stdout}        Verify Table


List with Input
    [Documentation]     Verify that typing python QWeb -A and python QWeb --all lists all keywords
    ${result}=          Run Process             ${python_ver}    -m     QWeb   -L      Get     shell=True
    Should Contain      ${result.stdout}        Get List
    Should Contain      ${result.stdout}        Get Text
    Should Not Contain  ${result.stdout}        Verify
    ${result}=          Run Process             ${python_ver}    -m     QWeb   --list  Get     shell=True
    Should Contain      ${result.stdout}        Get List
    Should Contain      ${result.stdout}        Get Text
    Should Not Contain  ${result.stdout}        Verify
...
Show doc for a keyword
    ...
    ${result}=          Run Process             ${python_ver}    -m     QWeb   -S      TypeText        shell=True
    Should Contain      ${result.stdout}        Type given text to a text field.
    ${result}=          Run Process             ${python_ver}    -m     QWeb   --show  Type Text       shell=True
    Should Contain      ${result.stdout}        Type given text to a text field.
    ${result}=          Run Process             ${python_ver}    -m     QWeb   --show  type text       shell=True
    Should Contain      ${result.stdout}        Type given text to a text field.
